...
@Description("A very general effect that can change many <a href='expressions.html'>expressions</a>. Many expressions can only be set and/or deleted, while some can have things added to or removed from them.")
@Examples({"# set:",
