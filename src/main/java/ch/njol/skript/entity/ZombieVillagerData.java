...
public class ZombieVillagerData extends EntityData<ZombieVillager> {
	...
	protected boolean equals_i(final EntityData<?> obj) {
		return obj instanceof ZombieVillagerData && ((ZombieVillagerData) obj).profession.equals(profession);
	}
	...
	public boolean isSupertypeOf(final EntityData<?> e) {
		return e instanceof ZombieVillagerData && ((ZombieVillagerData) e).profession.equals(profession);
	}
