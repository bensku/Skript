...
public class CondCompare extends Condition {
	...
	public static String f(final Expression<?> e) {
		...
		return Objects.requireNonNull(Classes.getSuperClassInfo(e.getReturnType())).getName().withIndefiniteArticle();
	}

	@SuppressWarnings({"unchecked", "Duplicates"})
	// duplicate is so small that it's honestly not worth to create a method
