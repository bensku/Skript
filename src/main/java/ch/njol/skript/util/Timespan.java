...
public class Timespan implements YggdrasilSerializable, Comparable<Timespan> { // REMIND unit
	...
	private final static long[] times = {50L, 1000L, 1000L * 60L, 1000L * 60L * 60L, 1000L * 60L * 60L * 24L};
	private final static HashMap<String, Long> parseValues = new HashMap<>();
	...
	private final static NonNullPair<Noun, Long>[] simpleValues = new NonNullPair[]{
