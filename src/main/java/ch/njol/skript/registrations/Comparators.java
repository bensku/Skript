...
public class Comparators {
	...
	public static Relation compare(final @Nullable Object o1, final @Nullable Object o2) {
		...
		@SuppressWarnings("null") final Comparator c = getComparator(o1.getClass(), o2.getClass());
		if (c == null)
			return Relation.NOT_EQUAL;
	...
	private final static class ConvertedComparator<T1, T2> implements Comparator<T1, T2> {
		...
		ConvertedComparator(final Converter<? super T1, ?> c1, final Comparator<?, ?> c) {
			this.c1 = c1;
			this.c = c;
			this.c2 = null;
		}

		ConvertedComparator(final Comparator<?, ?> c, final Converter<? super T2, ?> c2) {
			this.c1 = null;
			this.c = c;
			this.c2 = c2;
		}

		ConvertedComparator(final Converter<? super T1, ?> c1, final Comparator<?, ?> c, final Converter<? super T2, ?> c2) {
			this.c1 = c1;
			this.c = c;
			this.c2 = c2;
		}
