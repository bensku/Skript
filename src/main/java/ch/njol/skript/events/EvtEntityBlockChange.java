...
public class EvtEntityBlockChange extends SkriptEvent {
	...
	private enum ChangeEvent {
		...
		SILVERFISH_ENTER("silverfish enter", e -> e.getEntity() instanceof Silverfish && e.getTo() == Material.MONSTER_EGGS),
		SILVERFISH_EXIT("silverfish exit", e -> e.getEntity() instanceof Silverfish && e.getTo() != Material.MONSTER_EGGS);
	...
	public boolean check(final Event e) {
		return e instanceof EntityChangeBlockEvent && event.checker.check((EntityChangeBlockEvent) e);
	}
