...
public class Noun extends Message {
	...
	private final static HashMap<String, Integer> genders = new HashMap<>();
	...
	private final static List<String> indefiniteArticles = new ArrayList<>(3);
	private final static List<String> definiteArticles = new ArrayList<>(3);
	private static String definitePluralArticle = "";

	private final static List<String> localIndefiniteArticles = new ArrayList<>(3);
	private final static List<String> localDefiniteArticles = new ArrayList<>(3);
	private static String localDefinitePluralArticle = "";
