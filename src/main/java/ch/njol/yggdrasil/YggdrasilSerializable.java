...
public interface YggdrasilSerializable {
	...
	public static interface YggdrasilRobustSerializable extends YggdrasilSerializable {
		 ...
		 * <tt>yggdrasil.{@link Yggdrasil#incompatibleField(Object, Field, FieldContext) incompatibleField}(this, field,
		 * value)</tt> will be called.
		 */
		 ...
		 * @return Whether the field was handled. If false, <tt>yggdrasil.{@link Yggdrasil#excessiveField(Object,
		 * FieldContext) excessiveField}(this, field)</tt> will be called.
		 */
		@SuppressWarnings("null")
	...
	public static interface YggdrasilRobustEnum {
		 ...
		 * (because this method won't be able to return anything anyway).
		 *
	 ...
	 * stream should implement this interface. It provides two methods similar to Java's writeObject and readObject
	 * methods.
	 * <p>
	...
	public static interface YggdrasilExtendedSerializable extends YggdrasilSerializable {
		 ...
		 * <p>
		 * You can use <tt>return new {@link Fields#Fields(Object) Fields}(this);</tt> to emulate the default
		 * behaviour.
		 *
		...
		/**
		 * Deserialises this object. No fields have been set when this method is called, use <tt>fields.{@link
		 * Fields#setFields setFields}(this, yggdrasil)</tt> to set all compatible non-transient and non-static fields
		 * (and call incompatible/missing field handlers if applicable &ndash; this implies that errors will be thrown
		 * if the fields object is invalid).
		 * <p>
		 ...
		 * @throws StreamCorruptedException If the Fields object is invalid, i.e. was not written by {@link
		 *                                  #serialize()} or Yggrdasil's default serialisation.
