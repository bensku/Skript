<div class="is-white">
	...
	<div class="section">
		...
		<h1 class="title">Text in Scripts</h1>
		...
		<div class="section">
			...
			<h1 class="subtitle" id="formatting_text">
				<strong>Formatting Text</strong>
				<a href="#formatting_text">#</a>
			</h1>
		...
		<div class="section">
			...
			<h1 class="subtitle" id="other_styles">
				<strong>Other Styles</strong>
				<a href="#other_styles">#</a>
			</h1>
